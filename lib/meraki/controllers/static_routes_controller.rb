...
module Meraki
  ...
  class StaticRoutesController < BaseController
    ...
    # Add a static route
    # @param [String] network_id Required parameter: Example:
    # @param [CreateNetworkStaticRoutesModel] create_network_static_routes
    # Optional parameter: Example:
    # @return Mixed response from the API call
    def create_network_static_routes(options = {})
      # Validate required parameters.
      validate_parameters(
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_network_static_routes'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
