...
module Meraki
  ...
  class WirelessHealthController < BaseController
    ...
    # @param [String] t0 Optional parameter: Start of the requested time range
    # in seconds since epoch (Required)
    # @param [String] t1 Optional parameter: End of the requested time range in
    # seconds since epoch (Required)
    # @param [String] ssid Optional parameter: Filter results by SSID
    # @param [String] vlan Optional parameter: Filter results by VLAN
    ...
    # @param [String] client_id Optional parameter: Filter by client
    # @return Mixed response from the API call
