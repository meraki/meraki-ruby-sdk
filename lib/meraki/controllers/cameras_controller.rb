...
module Meraki
  ...
  class CamerasController < BaseController
    ...
    # @param [String] timestamp Optional parameter: The video link will start at
    # this timestamp. The timestamp is in UNIX Epoch time (milliseconds).
    ...
    # @param [String] network_id Required parameter: Example:
    # @param [String] serial Required parameter: Example:
    # @param [SnapshotNetworkCameraModel] snapshot_network_camera Optional
    # parameter: Example:
    # @return Mixed response from the API call
    def snapshot_network_camera(options = {})
      # Validate required parameters.
      validate_parameters(
        'network_id' => options['network_id'],
        'serial' => options['serial']
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['snapshot_network_camera'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
