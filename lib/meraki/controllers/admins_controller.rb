...
module Meraki
  ...
  class AdminsController < BaseController
    ...
    # @param [String] organization_id Required parameter: Example:
    # @param [CreateOrganizationAdminsModel] create_organization_admins Required
    # parameter: Example:
    # @return Mixed response from the API call
    def create_organization_admins(options = {})
      # Validate required parameters.
      validate_parameters(
        'organization_id' => options['organization_id'],
        'create_organization_admins' => options['create_organization_admins']
      )
      # Prepare query url.
      _path_url = '/organizations/{organizationId}/admins'
      _path_url = APIHelper.append_url_with_template_parameters(
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_organization_admins'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
