...
module Meraki
  ...
  class SwitchStacksController < BaseController
    ...
    # Create a stack
    # @param [String] network_id Required parameter: Example:
    # @param [CreateNetworkSwitchStacksModel] create_network_switch_stacks
    # Required parameter: Example:
    # @return Mixed response from the API call
    def create_network_switch_stacks(options = {})
      # Validate required parameters.
      validate_parameters(
        'network_id' => options['network_id'],
        'create_network_switch_stacks' => options['create_network_switch_stacks']
      )
      # Prepare query url.
      _path_url = '/networks/{networkId}/switchStacks'
      _path_url = APIHelper.append_url_with_template_parameters(
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_network_switch_stacks'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
