...
module Meraki
  ...
  class PIIController < BaseController
    ...
    # ```
    # @param [String] network_id Required parameter: Example:
    # @param [CreateNetworkPiiRequestsModel] create_network_pii_requests
    # Optional parameter: Example:
    # @return Mixed response from the API call
    def create_network_pii_requests(options = {})
      # Validate required parameters.
      validate_parameters(
        'network_id' => options['network_id']
      )
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_network_pii_requests'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
    ...
    def get_network_pii_request(options = {})
      ...
      # Prepare query url.
      _path_url = '/networks/{networkId}/pii/requests/{id}'
      _path_url = APIHelper.append_url_with_template_parameters(
        _path_url,
        'networkId' => options['network_id'],
        'id' => options['id']
