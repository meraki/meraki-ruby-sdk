...
module Meraki
  ...
  class ChangeLogController < BaseController
    @instance = ChangeLogController.new
    ...
    # equal to 365 days. The default is 365 days.
    # @param [Integer] per_page Optional parameter: The number of entries per
    # page returned. Acceptable range is 3 - 5000. Default is 5000.
    ...
    # client applications. The link for the first, last, prev, or next page in
    # the HTTP Link header should define it.
    # @param [String] network_id Optional parameter: Filters on the given
    # network
    # @param [String] admin_id Optional parameter: Filters on the given Admin
    # @return Mixed response from the API call
    def get_organization_configuration_changes(options = {})
      # Validate required parameters.
      validate_parameters(
        'organization_id' => options['organization_id']
      )
      # Prepare query url.
      _path_url = '/organizations/{organizationId}/configurationChanges'
