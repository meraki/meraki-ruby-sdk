...
module Meraki
  ...
  class NamedTagScopeController < BaseController
    ...
    # @param [String] with_details Optional parameter: Boolean indicating if the
    # the ids of the devices or users scoped by the target group should be
    ...
    # Add a target group
    # @param [String] network_id Required parameter: Example:
    # @param [CreateNetworkSmTargetGroupsModel] create_network_sm_target_groups
    # Optional parameter: Example:
    # @return Mixed response from the API call
    def create_network_sm_target_groups(options = {})
      # Validate required parameters.
      validate_parameters(
        'network_id' => options['network_id']
      )
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_network_sm_target_groups'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
    ...
    # @param [String] with_details Optional parameter: Boolean indicating if the
    # the ids of devices or users scoped by the target group should be included
    # in the response
    # @return Mixed response from the API call
