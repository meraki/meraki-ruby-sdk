...
module Meraki
  ...
  class NetworksController < BaseController
    ...
    # Create a network
    # @param [String] organization_id Required parameter: Example:
    # @param [CreateOrganizationNetworksModel] create_organization_networks
    # Required parameter: Example:
    # @return Mixed response from the API call
    def create_organization_networks(options = {})
      # Validate required parameters.
      validate_parameters(
        'organization_id' => options['organization_id'],
        'create_organization_networks' => options['create_organization_networks']
      )
      # Prepare query url.
      _path_url = '/organizations/{organizationId}/networks'
      _path_url = APIHelper.append_url_with_template_parameters(
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_organization_networks'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
