...
module Meraki
  ...
  class FirewalledServicesController < BaseController
    @instance = FirewalledServicesController.new
    ...
    # Return the accessibility settings of the given service ('ICMP', 'web', or
    # 'SNMP')
    # @param [String] network_id Required parameter: Example:
    # @param [String] service Required parameter: Example:
    # @return Mixed response from the API call
    def get_network_firewalled_service(options = {})
      # Validate required parameters.
      validate_parameters(
    ...
    # update_network_firewalled_service Required parameter: Example:
    # @return Mixed response from the API call
    def update_network_firewalled_service(options = {})
      ...
      validate_parameters(
        'network_id' => options['network_id'],
        'service' => options['service'],
        'update_network_firewalled_service' => options['update_network_firewalled_service']
      )
      # Prepare query url.
      _path_url = '/networks/{networkId}/firewalledServices/{service}'
      _path_url = APIHelper.append_url_with_template_parameters(
