...
module Meraki
  ...
  class SAMLRolesController < BaseController
    ...
    # Create a SAML role
    # @param [String] organization_id Required parameter: Example:
    # @param [CreateOrganizationSamlRolesModel] create_organization_saml_roles
    # Optional parameter: Example:
    # @return Mixed response from the API call
    def create_organization_saml_roles(options = {})
      # Validate required parameters.
      validate_parameters(
      ...
      _request = @http_client.post(
        _query_url,
        headers: _headers,
        parameters: options['create_organization_saml_roles'].to_json
      )
      CustomHeaderAuth.apply(_request)
      _context = execute_request(_request)
      validate_response(_context)
