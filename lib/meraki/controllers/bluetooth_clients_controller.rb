...
module Meraki
  ...
  class BluetoothClientsController < BaseController
    ...
    # @param [String] include_connectivity_history Optional parameter: Include
    # the connectivity history for this client
    # @param [String] connectivity_history_timespan Optional parameter: The
    ...
    def get_network_bluetooth_client(options = {})
      ...
      # Prepare query url.
      _path_url = '/networks/{networkId}/bluetoothClients/{id}'
    ...
    # client applications. The link for the first, last, prev, or next page in
    # the HTTP Link header should define it.
    # @param [String] timespan Optional parameter: The timespan, in seconds,
