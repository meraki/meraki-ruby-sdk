...
module Meraki
  # UpdateNetworkSwitchSettingsQosRuleModel Model.
  class UpdateNetworkSwitchSettingsQosRuleModel < BaseModel
    ...
    # DSCP tag that should be assigned to incoming packet. Set this to -1 to
    # trust incoming DSCP. Default value is 0.
    # @return [Integer]
    attr_accessor :dscp
    ...
    def self.from_hash(hash)
      ...
      UpdateNetworkSwitchSettingsQosRuleModel.new(vlan,
                                                  protocol,
                                                  src_port,
                                                  src_port_range,
                                                  dst_port,
