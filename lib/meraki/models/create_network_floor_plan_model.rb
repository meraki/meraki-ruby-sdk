...
module Meraki
  # CreateNetworkFloorPlanModel Model.
  class CreateNetworkFloorPlanModel < BaseModel
    ...
    # The file contents (a base 64 encoded string) of your image. Supported
    ...
    def self.from_hash(hash)
      ...
      center = CenterModel.from_hash(hash['center']) if hash['center']
      ...
      CreateNetworkFloorPlanModel.new(name,
                                      image_contents,
                                      center,
                                      bottom_left_corner,
                                      bottom_right_corner,
