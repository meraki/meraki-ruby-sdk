...
module Meraki
  ...
  class FiveGhzSettingsModel < BaseModel
    ...
    def self.from_hash(hash)
      ...
      FiveGhzSettingsModel.new(max_power,
                               min_power,
                               min_bitrate,
                               valid_auto_channels,
                               channel_width,
