...
module Meraki
  # CreateNetworkCameraQualityRetentionProfileModel Model.
  class CreateNetworkCameraQualityRetentionProfileModel < BaseModel
    ...
    def self.from_hash(hash)
      ...
      CreateNetworkCameraQualityRetentionProfileModel.new(name,
