...
module Meraki
  # CreateOrganizationNetworksModel Model.
  class CreateOrganizationNetworksModel < BaseModel
    # The name of the new network
    # @return [String]
    attr_accessor :name

    # The type of the new network. Valid types are wireless, appliance, switch,
    # phone, systemsManager, camera or a space-separated list of those for a
    # combined network.
    # @return [String]
    attr_accessor :type
    ...
    def self.from_hash(hash)
      ...
      CreateOrganizationNetworksModel.new(name,
                                          type,
                                          tags,
                                          time_zone,
