...
module Meraki
  ...
  class ApBandSettingsModel < BaseModel
    # Choice between 'dual', '2.4ghz' or '5ghz'. Defaults to dual.
    # @return [BandOperationModeEnum]
    attr_accessor :band_operation_mode

    # Steers client to most open band. Can be either true or false. Defaults to
    # true.
    # @return [Boolean]
    ...
    def self.from_hash(hash)
      ...
      ApBandSettingsModel.new(band_operation_mode,
