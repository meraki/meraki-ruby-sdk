...
module Meraki
  ...
  class UpdateNetworkSsidModel < BaseModel
    ...
    # Whether or not an SSID is accessible by 'enterprise' administrators
    # ('access disabled' or 'access enabled')
    # @return [EnterpriseAdminAccessEnum]
    attr_accessor :enterprise_admin_access
    ...
    # Specify the RADIUS attribute used to look up group policies ('Filter-Id',
    # 'Reply-Message', 'Airespace-ACL-Name' or 'Aruba-User-Role'). Access points
    # must receive this attribute in the RADIUS Access-Accept message
    # @return [String]
    attr_accessor :radius_attribute_for_group_policies
    ...
    # Whether or not traffic should be directed to use specific VLANs. This
    # param is only valid if the ipAssignmentMode is 'Bridge mode' or 'Layer 3
    # roaming'
    # @return [Boolean]
    attr_accessor :use_vlan_tagging

    # The concentrator to use when the ipAssignmentMode is 'Layer 3 roaming with
    # a concentrator' or 'VPN'.
    # @return [String]
    attr_accessor :concentrator_network_id

    # The VLAN ID used for VLAN tagging. This param is only valid when the
    ...
    # If true, the RADIUS response can override VLAN tag. This is not valid when
    # ipAssignmentMode is 'NAT mode'.
    # @return [Boolean]
    attr_accessor :radius_override
    ...
    def self.names
      ...
      @_hash['enterprise_admin_access'] = 'enterpriseAdminAccess'
      ...
      @_hash['radius_attribute_for_group_policies'] =
      ...
      @_hash['radius_override'] = 'radiusOverride'
    ...
    def initialize(name = nil,
                   ...
                   radius_attribute_for_group_policies = nil,
      ...
      @enabled = enabled
      @auth_mode = auth_mode
      @enterprise_admin_access = enterprise_admin_access
    ...
    def self.from_hash(hash)
      ...
      enterprise_admin_access = hash['enterpriseAdminAccess']
      ...
      radius_attribute_for_group_policies =
        hash['radiusAttributeForGroupPolicies']
      ...
      radius_override = hash['radiusOverride']
