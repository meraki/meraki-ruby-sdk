...
module Meraki
  # UpdateNetworkApplianceFirewallInboundFirewallRulesModel Model.
  class UpdateNetworkApplianceFirewallInboundFirewallRulesModel < BaseModel
    ...
    def self.from_hash(hash)
      ...
      UpdateNetworkApplianceFirewallInboundFirewallRulesModel.new(rules,
                                                                  syslog_default_rule)
    end
  end
end
