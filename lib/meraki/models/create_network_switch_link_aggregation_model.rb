...
module Meraki
  # CreateNetworkSwitchLinkAggregationModel Model.
  class CreateNetworkSwitchLinkAggregationModel < BaseModel
    # Array of switch or stack ports for creating aggregation group. Minimum 2
    # and maximum 8 ports are supported.
    # @return [List of SwitchPortModel]
    attr_accessor :switch_ports

    # Array of switch profile ports for creating aggregation group. Minimum 2
    # and maximum 8 ports are supported.
    ...
    def self.from_hash(hash)
      ...
      CreateNetworkSwitchLinkAggregationModel.new(switch_ports,
                                                  switch_profile_ports)
    end
  end
end
