...
module Meraki
  # UpdateNetworkCellularGatewaySettingsConnectivityMonitoringDestinationsModel Model.
  class UpdateNetworkCellularGatewaySettingsConnectivityMonitoringDestinationsModel < BaseModel
    ...
    def self.from_hash(hash)
      ...
      UpdateNetworkCellularGatewaySettingsConnectivityMonitoringDestinationsModel.new(destinations)
    end
  end
end
